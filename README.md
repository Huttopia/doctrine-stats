[![version](https://img.shields.io/badge/version-symfony44-green.svg)](https://github.com/huttopia/doctrine-stats/tree/1.3.4)
[![doctrine](https://img.shields.io/badge/doctrine/orm-^2.9.x-blue.svg)](http://www.doctrine-project.org)
...
```bash
composer require --dev "huttopia/doctrine-stats": "dev-symfony44"
```
